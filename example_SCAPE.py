...
data_dir = "C:/Users/miked/OneDrive - UCSF/Documents/MATLAB/SCAPE/Data/HiCAM_2000/165mm/NeuroPAL/20240823_OH16290_worm1_SmallArena_v5_run2"; numz = 200; end_t = 1; pixel_size = (0.48, 0.5, 0.55)
...
arguments = {
    ...
    "gaussian": False,
    'median': 3,
    "remove_blobs_dist": 3, #3
    "blob_merge_dist_thresh": 1, #5
    "mip_movie": True,
    "marker_movie": True,
    "infill": True,
    'quantile': 0.953,
    ...
    "quant_args": {
        ...
        "quant_voxels": 5, #20  # number of pixels/voxels to quantify within mask (average of brightest n)
    },
}
